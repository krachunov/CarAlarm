...
public class CreateNewUsers extends JFrame {
	...
	public CreateNewUsers() {
		...
		JLabel lblAdminPermission = new JLabel("Admin permission");
		...
		JRadioButton adminPermissionRadioButton = new JRadioButton("Set Admin");
		...
		getContentPane().add(adminPermissionRadioButton, gbc_adminPermissionRadioButton);
		...
		JRadioButton userPermissionRadioButton = new JRadioButton("Set User");
		...
		getContentPane().add(userPermissionRadioButton, gbc_userPermissionRadioButton);
